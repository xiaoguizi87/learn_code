      ...
      <view class="cu-dialog bg-white" @tap.stop>
        ...
        <radio-group class="block">
          <view class="cu-list menu text-left">
            <view class="cu-item cu-item-error" v-for="(error, idx) in errorList" :key=idx>
          ...
          <view v-if="index-subjectIndex>=-1&&index-subjectIndex<=1">
            ...
            <view>
              ...
              <radio-group class="block" @change="RadioboxChange" v-if="subject.type===1||subject.type===2">
                <view class="cu-form-group" v-for="(option, idx) in subject.optionList" :key=idx>
              ...
              <checkbox-group class="block" @change="CheckboxChange" v-else-if="subject.type===3">
                <view class="cu-form-group" v-for="(option, index) in subject.optionList" :key=index>
                  <checkbox :value="option.id" :class="subject.userAnswer.indexOf(option.id) > -1?'checked':''"
            ...
            <view v-if='subjectIndex == 5' class="padding flex flex-direction ">
              <button class="cu-btn bg-red margin-tb-sm lg" @click="submitAnser()">提 交</button>
            </view>
